...
<template>
    <Modal :show="showAddModal" @close="() => { showAddModal = false; }">
        <MaterialDistributionSave v-model:show="showAddModal" v-model:item="materialDistributionForm" @updateDatabase="updateDatabase" :companyId="companyId" :materialId="materialId"/>
    </Modal>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-6">
                    Gerenciar lotes
                    <PrimaryButton style="" class="float-right" @click="() => { showAddModal = true }">Adicionar novo lote</PrimaryButton>
                </h2>
