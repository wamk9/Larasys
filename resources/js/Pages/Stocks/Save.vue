    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <InputLabel class="mt-3">Preço do equipamento</InputLabel>
                ...
                <InputLabel class="mt-3">Depreciação</InputLabel>
                <TextInput v-model="form.depreciation" style="width: 100%"/>

                <InputLabel class="mt-3">Data máxima de retorno do investimento</InputLabel>
                <TextInput v-model="form.max_date_return_value" style="width: 100%"/>

                <InputLabel class="mt-3">Valor de retorno do investimento</InputLabel>
                <TextInput v-model="form.return_value" style="width: 100%"/>

                <InputLabel class="mt-3">Valor de uso</InputLabel>
                <TextInput v-model="form.use_value" style="width: 100%"/>

                <InputLabel class="mt-3">Consumo em watts</InputLabel>
                <TextInput v-model="form.watts_consume" style="width: 100%"/>
...
export default {
    ...
    methods: {
        ...
        fillForm() {
            ...
            this.form.bought_at = this.item.bought_at;
            this.form.depreciation = this.item.depreciation;
            this.form.max_date_return_value = this.item.max_date_return_value;
    ...
    computed: {
        modalTitle(){
            return !!this.form.id ? 'Gerenciar equipamento' : 'Adicionar novo equipamento';
        },
    },
    created() {
        this.fillForm();
